          ...
          <div className="mx-auto grid max-w-7xl items-start gap-6 px-4 lg:grid-cols-[1.08fr_0.92fr]">
            <Reveal className="h-full">
              <Card
                className={cn(
                  themedCard(0),
                  "relative overflow-hidden rounded-[2rem] p-7 md:p-10 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.2)]",
                )}
              >
                <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#0095ff] via-[#bfdbfe] to-[#0095ff]" />
            ...
            <div className="grid gap-6">
              <Reveal delay={0.08}>
                <Card className="overflow-hidden rounded-[2rem] border border-[#0095ff]/15 bg-gradient-to-br from-[#f0f9ff] via-[#dbeafe] to-[#f8fbff] text-slate-950 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.12)]">
                  ...
                  <div className="p-7">
                    <GoogleMapsIcon className="mb-4 h-8 w-8 text-[#0095ff]" />

                    <h3 className="text-3xl font-semibold text-[#0095ff]">Visit our store</h3>
