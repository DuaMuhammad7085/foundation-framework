  ...
  return (
    <Layout>
      <div className="relative min-h-screen bg-[#F5F1ED]">
        ...
        eyebrow=""
        eyebrowClassName="border-[#5bbcff]/55 bg-[#e8f4ff] text-[#0f3b6f]"
        title={
          <>
            <span className="block font-serif text-4xl md:text-[5rem] lg:text-[6rem] font-semibold leading-[0.96] tracking-tight mb-2 text-white drop-shadow-[0_28px_60px_rgba(0,0,0,0.35)]">
              Precision Repair.
            </span>
            <span className="block font-serif text-4xl md:text-[5rem] lg:text-[6rem] font-normal leading-[0.96] tracking-tight text-white -mt-1">
              Confidence Restored.
            </span>
          </>
        }
        subtitle={
          <>
            Fast, expert repairs for phones, tablets, and laptops — backed by honest advice,
            premium parts, and same-day service from technicians who treat every device like their own.
          </>
        }
        actions={
          <>
            <Button
              asChild
              size="lg"
              className="bg-gradient-cta text-white rounded-sm px-8 h-12 uppercase tracking-widest text-xs font-semibold shadow-sm"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white/60 text-white bg-white/10 hover:bg-white/20 rounded-sm px-8 h-12 uppercase tracking-widest text-xs font-semibold"
            >
              <Link to="/profile">Track My Repair</Link>
            </Button>
          </>
        }
        overlayClassName="bg-[linear-gradient(110deg,rgba(3,18,42,0.88)_0%,rgba(16,39,75,0.88)_30%,rgba(0,0,0,0.55)_55%,rgba(0,0,0,0.18)_80%)]"
        imageClassName="object-cover filter brightness-60 contrast-105"
      />
          ...
          <Reveal delay={0.2}>
            <div className="mt-12 flex flex-col items-center justify-center gap-4 text-center sm:flex-row sm:justify-between">
              <p className="max-w-2xl text-sm text-slate-500">
                Our customers rate us highly for fast turnaround, honest pricing and reliable repair
                work. See more reviews from Nuneaton locals.
              </p>
              <Link
                to="/about"
                className="inline-flex items-center justify-center rounded-full bg-gradient-purple-blue px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-[#0095ff]/20 transition hover:bg-gradient-purple-blue-hover"
              >
                Read More Reviews
              </Link>
            </div>
      ...
      <section className="relative overflow-hidden py-24 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          <Reveal>
            <motion.div
              className="relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-200/70 p-10 md:p-12 shadow-[0_30px_90px_-30px_rgba(15,23,42,0.12)]"
              ...
              <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                ...
                >
                  <img
                    ...
                    className="w-full h-full object-cover min-h-[460px] rounded-[1.75rem]"
                    loading="lazy"
                  />
                </motion.div>
              </div>
